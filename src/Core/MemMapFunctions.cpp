...
#define currentMIPS ((MIPSState*)0) // EMCC_CHANGE: This is only for logging of exceptions, so not needed for our usecase

namespace Memory {

u8* base = nullptr; // EMCC_CHANGE: From MemMap.cpp, which pulls in tons of files
u32 g_MemorySize = 0; // EMCC_CHANGE: From MemMap.cpp, which pulls in tons of files
